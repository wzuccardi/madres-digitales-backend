    ...
    try {
        ...
        if (req.file) {
            ...
            if (contenidoExistente.url_contenido) {
                const oldFilePath = path_1.default.join(__dirname, '../../uploads', path_1.default.basename(contenidoExistente.url_contenido));
                try {
...
const eliminarContenido = async (req, res) => {
    try {
        ...
        if (contenido.url_contenido) {
            const filePath = path_1.default.join(__dirname, '../../uploads', path_1.default.basename(contenido.url_contenido));
            try {

...
exports.reasignarMadrina = exports.getGestantesDisponiblesParaAlertas = exports.calcularRiesgo = exports.asignarMadrina = exports.buscarGestantesCercanas = exports.deleteGestante = exports.updateGestante = exports.createGestante = exports.getGestanteById = exports.getAllGestantes = void 0;
 ...
 */
const getGestantesDisponiblesParaAlertas = async (req, res) => {
    try {
...
exports.getGestantesDisponiblesParaAlertas = getGestantesDisponiblesParaAlertas;
/**
 * Reasignar madrina a gestante (con validación de permisos)
 */
const reasignarMadrina = async (req, res) => {
    try {
        const userId = req.user?.id;
...
exports.reasignarMadrina = reasignarMadrina;

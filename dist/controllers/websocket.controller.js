...
exports.broadcastMaintenance = exports.disconnectUser = exports.sendTestNotification = exports.getWebSocketStats = void 0;
/**
 ...
 */
const broadcastMaintenance = async (req, res) => {
    try {
        const user = req.user;
        if (!user) {
            return res.status(401).json({

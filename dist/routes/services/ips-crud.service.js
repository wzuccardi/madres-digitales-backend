...
class IpsCrudService {
    ...
    async getNearbyIps(latitude, longitude, radiusKm = 10) {
        try {
            ...
            // Como el modelo actual no tiene coordenadas, retornar todas las IPS activas
            // En una implementación real, se agregaría el campo coordenadas al modelo
            const nearbyIps = ipsList;
            console.log(`✅ IpsCrudService: Found ${nearbyIps.length} nearby IPS`);
            return nearbyIps;
        }
        catch (error) {

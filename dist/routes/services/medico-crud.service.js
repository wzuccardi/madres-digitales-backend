...
class MedicoCrudService {
    ...
    async updateMedico(id, data) {
        try {
            ...
            if (data.registro_medico !== undefined)
                updateData.registro_medico = data.registro_medico;
            ...
            if (data.ips_id !== undefined)
                updateData.ips_id = data.ips_id;
    ...
    async searchMedicosByName(searchTerm) {
        try {
...
exports.default = new MedicoCrudService();

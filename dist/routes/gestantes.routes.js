 ...
 */
router.get('/disponibles-para-alertas', gestante_controller_1.getGestantesDisponiblesParaAlertas);
/**
 * @swagger
 ...
 */
router.put('/:id/asignar-madrina', gestante_controller_1.reasignarMadrina);
/**
 * @swagger
 * /api/gestantes/{id}:
 *   put:

...
router.get('/integrados', auth_middleware_1.authMiddleware, municipios_controller_1.getMunicipiosIntegrados); // Obtener municipios con estadísticas integradas
...
router.post('/import/bolivar', auth_middleware_1.authMiddleware, municipios_controller_1.importarMunicipiosBolivar); // Importar municipios de Bolívar
router.post('/:id/activar', auth_middleware_1.authMiddleware, municipios_controller_1.activarMunicipio); // Activar municipio
router.post('/:id/desactivar', auth_middleware_1.authMiddleware, municipios_controller_1.desactivarMunicipio); // Desactivar municipio

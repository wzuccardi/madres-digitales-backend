 ...
 */
router.get('/', (0, validation_middleware_1.validate)(contenido_dto_1.buscarContenidoSchema, 'query'), contenidoController.buscarContenido);
/**
 ...
 */
router.post('/', auth_middleware_1.authMiddleware, (0, role_middleware_1.requireMinRole)(role_middleware_1.UsuarioRol.COORDINADOR), file_utils_1.upload.single('archivo'), contenidoController.crearContenido);
/**
 * GET /api/contenido/favoritos
 * Obtener favoritos del usuario (requiere autenticación)
 */
router.get('/favoritos', auth_middleware_1.authMiddleware, contenidoController.obtenerFavoritos);
/**
 ...
 * Soporta subida de archivo con campo 'archivo'
 */
router.put('/:id', auth_middleware_1.authMiddleware, (0, role_middleware_1.requireMinRole)(role_middleware_1.UsuarioRol.COORDINADOR), file_utils_1.upload.single('archivo'), contenidoController.actualizarContenido);
/**
 * DELETE /api/contenido/:id
 * Eliminar contenido
 * Requiere rol: Admin o superior
 */
router.delete('/:id', auth_middleware_1.authMiddleware, (0, role_middleware_1.requireMinRole)(role_middleware_1.UsuarioRol.ADMIN), contenidoController.eliminarContenido);
/**
 * POST /api/contenido/:id/progreso
 * Actualizar progreso del usuario en el contenido (requiere autenticación)
 */
router.post('/:id/progreso', auth_middleware_1.authMiddleware, contenidoController.actualizarProgreso);
/**
 ...
 */
router.post('/:id/calificar', auth_middleware_1.authMiddleware, contenidoController.calificarContenido);

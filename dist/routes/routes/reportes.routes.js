 ...
 */
router.get('/resumen-general', auth_middleware_1.authenticateToken, reporte_controller_1.getResumenGeneral);
/**
 * @swagger
 ...
 *         description: Error del servidor
 */
router.get('/estadisticas-gestantes', auth_middleware_1.authenticateToken, reporte_controller_1.getEstadisticasGestantes);
/**
 * @swagger
 ...
 *         description: Error del servidor
 */
router.get('/estadisticas-controles', auth_middleware_1.authenticateToken, reporte_controller_1.getEstadisticasControles);
/**
 * @swagger
 ...
 *         description: Error del servidor
 */
router.get('/estadisticas-alertas', auth_middleware_1.authenticateToken, reporte_controller_1.getEstadisticasAlertas);
/**
 * @swagger
 ...
 *         description: Error del servidor
 */
router.get('/estadisticas-riesgo', auth_middleware_1.authenticateToken, reporte_controller_1.getEstadisticasRiesgo);
/**
 * @swagger
 ...
 *         description: Error del servidor
 */
router.get('/tendencias', auth_middleware_1.authenticateToken, reporte_controller_1.getTendencias);

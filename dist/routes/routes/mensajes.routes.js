 ...
 * }
 */
router.post('/conversaciones/:id/participantes', mensajeController.agregarParticipante);
/**
 * DELETE /api/mensajes/conversaciones/:id/participantes/:usuarioId
 * Eliminar participante de conversación
 */
router.delete('/conversaciones/:id/participantes/:usuarioId', mensajeController.eliminarParticipante);
/**
 ...
 */
router.get('/buscar', mensajeController.buscarMensajes);

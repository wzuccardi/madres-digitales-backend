...
router.post('/register-admin', auth_middleware_1.authenticateToken, rate_limit_middleware_1.registerLimiter, auth_controller_1.register); // Endpoint para administrar usuarios con roles especiales

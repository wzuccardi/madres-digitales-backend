 ...
 */
router.get('/', auth_middleware_1.authMiddleware, ips_crud_controller_1.getAllIps);
/**
 * @swagger
 * /api/ips-crud/active:
 *   get:
 ...
 */
router.get('/active', auth_middleware_1.authMiddleware, ips_crud_controller_1.getActiveIps);
/**
 * @swagger
 * /api/ips-crud/search:
 *   get:
 ...
 */
router.get('/search', auth_middleware_1.authMiddleware, ips_crud_controller_1.searchIps);
/**
 * @swagger
 * /api/ips-crud/nearby:
 *   get:
 ...
 */
router.get('/nearby', auth_middleware_1.authMiddleware, ips_crud_controller_1.getNearbyIps);
/**
 * @swagger
 ...
 */
router.get('/municipio/:municipioId', auth_middleware_1.authMiddleware, ips_crud_controller_1.getIpsByMunicipio);
/**
 * @swagger
 * /api/ips-crud/{id}:
 *   get:
 ...
 */
router.get('/:id', auth_middleware_1.authMiddleware, ips_crud_controller_1.getIpsById);
/**
 * @swagger
 * /api/ips-crud:
 *   post:
 ...
 */
router.post('/', auth_middleware_1.authMiddleware, ips_crud_controller_1.createIps);
/**
 * @swagger
 * /api/ips-crud/{id}:
 *   put:
 ...
 */
router.put('/:id', auth_middleware_1.authMiddleware, ips_crud_controller_1.updateIps);
/**
 * @swagger
 * /api/ips-crud/{id}:
 *   delete:
 ...
 */
router.delete('/:id', auth_middleware_1.authMiddleware, ips_crud_controller_1.deleteIps);

...
async function testSuperAdminFlow() {
    ...
    try {
        ...
        const municipiosResponse = await axios_1.default.get('http://localhost:3000/api/municipios', { headers });
        ...
        if (municipios.length > 0) {
            ...
            try {
                ...
                const cambioResponse = await axios_1.default.post(`http://localhost:3000/api/municipios/${municipioTest.id}/${endpoint}`, {}, { headers });
                ...
                const restaurarResponse = await axios_1.default.post(`http://localhost:3000/api/municipios/${municipioTest.id}/${restaurarEndpoint}`, {}, { headers });
        ...
        try {
            const statsResponse = await axios_1.default.get('http://localhost:3000/api/municipios/stats', { headers });

...
exports.setupCompleteSystem = setupCompleteSystem;
const client_1 = require("@prisma/client");
const child_process_1 = require("child_process");
const fs = __importStar(require("fs"));
const path = __importStar(require("path"));
const import_municipios_bolivar_1 = require("./import-municipios-bolivar");
...
async function configurarPostGIS() {
    ...
    try {
        ...
        const sqlScript = fs.readFileSync(path.join(__dirname, 'setup-postgis.sql'), 'utf-8');

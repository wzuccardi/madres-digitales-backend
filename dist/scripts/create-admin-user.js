...
async function createAdminUser() {
    try {
        ...
        const coordinadorHash = await bcrypt_1.default.hash(coordinadorPassword, 10);
        ...
        const medicoHash = await bcrypt_1.default.hash(medicoPassword, 10);
        ...
        const madrinaHash = await bcrypt_1.default.hash(madrinaPassword, 10);
        ...
        const adminDemoHash = await bcrypt_1.default.hash(adminDemoPassword, 10);

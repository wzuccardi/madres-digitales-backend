...
class AlertaService {
    ...
    async getAlertasByUser(userId) {
        try {
            ...
            logger_1.log.error('Error obteniendo alertas por usuario', { error: error.message, userId });
     ...
     */
    async createAlerta(data, userId) {
        try {
            ...
            logger_1.log.info('Alerta creada', {
            ...
            logger_1.log.error('Error creando alerta', { error: error.message, data, userId });
            throw error;
        }
    }
    /**
     ...
     */
    async getAlertaById(alertaId, userId) {
        try {
            ...
            logger_1.log.error('Error obteniendo alerta por ID', { error: error.message, alertaId, userId });
            throw error;
        }
    }
    /**
    ...
    async resolverAlerta(alertaId, userId) {
        try {
            ...
            logger_1.log.info('Alerta resuelta', { alertaId, userId, gestanteId: alerta.gestante_id });
            ...
            logger_1.log.error('Error resolviendo alerta', { error: error.message, alertaId, userId });
            throw error;
        }
    }
    /**
     ...
     */
    async createAlertaConEvaluacion(data) {
        try {
